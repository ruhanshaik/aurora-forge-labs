...
export const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    icon: 'Cloud',
    image: 'portfolio-saas',
    techStack: ['Next.js', 'Stripe', 'AWS', 'PostgreSQL'],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    icon: 'TrendingUp',
    image: 'portfolio-marketing',
    techStack: ['Google Ads', 'SEO Tools', 'Analytics', 'Funnels'],
  },
  {
    id: 7,
    ...
    icon: 'Share2',
    image: 'portfolio-social',
    techStack: ['Meta Ads', 'Canva', 'Analytics', 'Scheduling'],
  },
];
